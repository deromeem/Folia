...
require_once JPATH_COMPONENT_ADMINISTRATOR.'/models/mpage.php';

class FoliaModelForm_page extends FoliaModelMpage
{
	protected $_context = 'mpage';
	...
	{
		$itemId = (int) (!empty($itemId)) ? $itemId : $this->getState('page.id');
