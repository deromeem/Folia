...
class FoliaControllerEtudiant extends JControllerForm
{
	...
	protected function getReturnPage()
	{
		...
		// }
		return JURI::base()."/index.php?option=com_folia&view=etudiants";		
	}

	public function getModel($name = 'form_e', $prefix = '', $config = array('ignore_request' => true))
	{
