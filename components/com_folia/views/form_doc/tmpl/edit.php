		...
		<form action="<?php echo JRoute::_('index.php?option=com_folia&a_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
			...
			<div class="form-inline form-inline-header">
				...
				<div class="btn-toolbar">
					...
					<div class="btn-group pull-right">
						<button type="button" class="btn btn-primary validate" onclick="Joomla.submitbutton('document.save')">
			...
			<fieldset>
				<ul class="nav nav-tabs">
					<li><a href="#document" data-toggle="tab"><?php echo JText::_('COM_FOLIA_PORTFOLIO'); ?></a></li>
						...
						<table class="table">
							<tbody>
								...
								<tr>
									...
									<td width="80%">
										<div class="controls"><?php echo $this->form->getInput('nomFichier'); ?></div>
									</td>
								</tr>
								<tr>
									<td width="20%" class="nowrap right">
								...
								<tr>
									...
									<td width="80%">
										...
										if($isNew){
											...
											$explode = explode("=", $url);
											$id  = $explode[3];
										echo $this->form->getInput('blocs_id');
										} ?></div>
									</td>
								</tr>
							</tbody>
