...
<?php else : ?>
	...
	<script type="text/javascript">
		...
		Joomla.submitbutton = function(task)
		{
			...
			if (task == 'commentaire.cancel' || document.formvalidator.isValid(document.getElementById('adminForm')))
			{
		...
		<form action="<?php echo JRoute::_('index.php?option=com_folia&a_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
			...
			<div class="form-inline form-inline-header">
				<div class="btn-group pull-left">
					...
					<h2><?php echo JText::_('COM_FOLIA_COMMENTAIRE')." ".($isNew ? JText::_('COM_FOLIA_ADD_PAR'): JText::_('COM_FOLIA_MODIF_PAR')); ?></h2>
				</div>
				<div class="btn-toolbar">
					<div class="btn-group pull-right">
						<button type="button" class="btn" onclick="Joomla.submitbutton('commentaire.cancel')">
							<span class="icon-cancel"></span>
						</button>
					</div>
					<div class="btn-group pull-right">
						<button type="button" class="btn btn-primary validate" onclick="Joomla.submitbutton('commentaire.save')">
			...
			<fieldset>
				<ul class="nav nav-tabs">
					<li><a href="#commentaire" data-toggle="tab"><?php echo JText::_('COM_FOLIA_COMMENTAIRE'); ?></a></li>
					...
					<div class="tab-pane active" id="commentaire">
						<table class="table">
							<tbody>
								...
								<tr>
									<td width="20%" class="nowrap right">
										<div class="control-label"><?php echo $this->form->getLabel('portfolio'); ?></div>
									</td>
									<td width="80%">
										<div class="controls"><?php echo $this->form->getInput('portfolio'); ?></div>
									</td>
								</tr>
								<!-- <tr>
									<td width="20%" class="nowrap right">
