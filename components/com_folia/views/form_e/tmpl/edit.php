		...
		<form action="<?php echo JRoute::_('index.php?option=com_folia&a_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
			...
			<div class="form-inline form-inline-header">
				...
				<div class="btn-toolbar">
					<div class="btn-group pull-right">
						<button type="button" class="btn" onclick="Joomla.submitbutton('etudiant.cancel')">
							<span class="icon-cancel"></span>
						</button>
					</div>
					<div class="btn-group pull-right">
						<button type="button" class="btn btn-primary validate" onclick="Joomla.submitbutton('etudiant.save')">
			...
			<fieldset>
				<ul class="nav nav-tabs">
					<li><a href="#etudiant" data-toggle="tab"><?php echo JText::_('COM_FOLIA_ETUDIANT'); ?></a></li>
