...
<?php else : ?>
	...
	<div class="edit item-page">
		<form action="<?php echo JRoute::_('index.php?option=com_folia&view=utilisateur&u_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
			
			<div class="form-inline form-inline-header">
				<div class="btn-group pull-left">
					<?php $isNew = ($this->item->id == 0); ?>
					<h2><?php echo JText::_('COM_FOLIA_UTILISATEUR')." ".($isNew ? JText::_('COM_UTILISATEUR_ADD_PAR'): JText::_('COM_UTILISATEUR_MODIF_PAR')); ?></h2>
				</div>
			...
			<fieldset>
				<ul class="nav nav-tabs">
					<li><a href="#utilisateur" data-toggle="tab"><?php echo JText::_('COM_FOLIA_UTILISATEUR'); ?></a></li>
