...
<?php else : ?>
	<div class="form-inline form-inline-header">
		...
		<div class="btn-group pull-right">
			<a href="<?php echo JRoute::_('index.php?option=com_folia&view=form_bloc&layout=edit&id='.$this->item->id); ?>" class="btn" role="button"><span class="icon-edit"></span></a>
		</div>
	</div>
	<div>
		<table class="table">
	...
	?>
		<h2>Documents du Bloc</h2>
			...
			$explode = explode("=", $url);
			$numberid = $explode[3];
			echo JRoute::_('index.php?option=com_folia&view=form_doc&layout=edit&idbloc='.$numberid); ?>" class="btn" role="button"><span class="icon-plus"></span></a>
		</div>
