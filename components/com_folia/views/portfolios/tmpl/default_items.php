...
$uriCompoDetail = JURI::base(true)."/index.php?option=com_folia&view=portfolio&id=";
...
<form action="<?php echo JUri::getInstance()->toString(); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped" id="articleList">
		<thead>
			<tr>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_FOLIA_PORTFOLIOS_TITRE'), 'titre', $listDirn, $listOrder) ?>
				</th>
				<th class="title">
