...
$uriCompoDetail = JURI::base(true)."/index.php?option=com_folia&view=bloc&id=";
...
<?php else : ?>
	<div class="form-inline form-inline-header">
		...
		<div class="btn-group pull-right">
			<a href="<?php echo JURI::base(true).'/index.php?option=com_folia&view=portfolio&id='.$this->return->portfolios_id ?>" class="btn" role="button">
