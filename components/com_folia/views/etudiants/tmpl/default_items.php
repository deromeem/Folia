...
$uriCompoDetail = JURI::base(true)."/index.php?option=com_folia&view=etudiant&id=";
...
<form action="<?php echo JUri::getInstance()->toString(); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div class="form-inline form-inline-header">
		...
		<div class="btn-group pull-left">
			<a href="<?php echo JRoute::_('index.php?option=com_folia&view=form_e&layout=edit'); ?>" class="btn" role="button"><span class="icon-plus"></span></a>
		</div>	
	...
	<table class="table table-striped" id="articleList">
		<thead>
			<tr>
				...
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_FOLIA_ETUDIANTS_TYPECONTACT'), 'typecontact', $listDirn, $listOrder) ?>
				</th>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_FOLIA_ETUDIANTS_ENTREPRISE'), 'entreprise', $listDirn, $listOrder) ?>
				</th>
