...
<?php else : ?>
	...
	<script type="text/javascript">
		...
		Joomla.submitbutton = function(task)
		{
			...
			if (task == 'mbloc.cancel' || document.formvalidator.isValid(document.getElementById('adminForm')))
			{
		...
		<form action="<?php echo JRoute::_('index.php?option=com_folia&a_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
			...
			<div class="form-inline form-inline-header">
				...
				<div class="btn-toolbar">
					<div class="btn-group pull-right">
						<button type="button" class="btn" onclick="Joomla.submitbutton('mbloc.cancel')">
							<span class="icon-cancel"></span>
						</button>
					</div>
					<div class="btn-group pull-right">
						<button type="button" class="btn btn-primary validate" onclick="Joomla.submitbutton('mbloc.save')">
			...
			<fieldset>
				<ul class="nav nav-tabs">
					<li><a href="#bloc" data-toggle="tab"><?php echo JText::_('COM_FOLIA_PORTFOLIO'); ?></a></li>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="bloc">
						<table class="table">
							<tbody>
								<tr>
								...
								<tr>
									<td width="20%" class="nowrap right">
										<div class="control-label"><?php echo $this->form->getLabel('activites_id'); ?></div>
									</td>
									<td width="80%">
								...
								<tr>
									...
									<td width="80%">
										...
										if($isNew){
											...
											$explode = explode("=", $url);
											$id  = $explode[3];
										echo $this->form->getInput('pages_id',null,$id);} ?></div>
									</td>
								</tr>
							</tbody>
						</table>
