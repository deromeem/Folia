...
class FoliaModelTuteurs extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		parent::populateState('t.societe', 'asc');
	}
	...
	protected function getListQuery()
	{
		...
		$query->select('t.id, u.nom, u.prenom, t.email, t.societe, t.service, t.published, t.hits, t.modified');
		$query->from('`#__folia_tuteurs` t, `#__folia_utilisateurs` u');
		$query->where('t.email = u.email');
		...
		// tri des colonnes
		$orderCol = $this->state->get('list.ordering', 't.societe');
