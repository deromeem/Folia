...
class FoliaModelprofesseurs extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->select('p.id, p.email, p.published, p.hits, p.modified');
		$query->from('#__folia_professeurs p');

		$query->select('u.nom, u.prenom')->join('LEFT', '#__folia_utilisateurs AS u ON u.email=p.email');
