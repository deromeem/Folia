...
class FoliaModelGroupe extends JModelAdmin
{
	protected $_compo = 'com_groupe';
	protected $_context = 'groupe';
	public $typeAlias = 'com_folia.groupe';
	
	// Surcharges des m�thodes de la classe m�re pour :
	
	// 1) d�finir la table de soutien � utiliser
	public function getTable($type = 'Groupe', $prefix = 'FoliaTable', $config = array()) 
	{
