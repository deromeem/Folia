...
class FoliaModelGroupePartage extends JModelAdmin
{
	protected $_compo = 'com_folia';
	protected $_context = 'groupePartage';
	public $typeAlias = 'com_folia.groupePartage';
	
	// Surcharges des m�thodes de la classe m�re pour :
	
	// 1) d�finir la table de soutien � utiliser
	public function getTable($type = 'GroupePartage', $prefix = 'FoliaTable', $config = array()) 
	{
