...
class FoliaModelCommentaire extends JModelAdmin
{
	protected $_compo = 'com_folia';
	protected $_context = 'commentaire';
	public $typeAlias = 'com_folia.commentaire';
	
	// Surcharges des m�thodes de la classe m�re pour :
	
	// 1) d�finir la table de soutien � utiliser
	public function getTable($type = 'Commentaire', $prefix = 'FoliaTable', $config = array()) 
	{
