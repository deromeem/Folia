...
class FoliaModelPage extends JModelAdmin
{
	protected $_compo = 'com_folia';
	protected $_context = 'page';
	public $typeAlias = 'com_folia.page';
	
	// Surcharges des m�thodes de la classe m�re pour :
	
	// 1) d�finir la table de soutien � utiliser
	public function getTable($type = 'Page', $prefix = 'FoliaTable', $config = array()) 
	{
