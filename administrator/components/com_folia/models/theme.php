...
class FoliaModelTheme extends JModelAdmin
{
	protected $_compo = 'com_folia';
	protected $_context = 'theme';
	public $typeAlias = 'com_folia.theme';
	
	// Surcharges des m�thodes de la classe m�re pour :
	
	// 1) d�finir la table de soutien � utiliser
	public function getTable($type = 'Theme', $prefix = 'FoliaTable', $config = array())
	{
