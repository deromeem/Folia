...
class FoliaModelReferentiel extends JModelAdmin
{
	protected $_compo = 'com_folia';
	protected $_context = 'referentiel';
	public $typeAlias = 'com_folia.referentiel';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Referentiel', $prefix = 'FoliaTable', $config = array()) 
	{
