...
class FoliaModelTuteur extends JModelAdmin
{
	protected $_compo = 'com_folia';
	protected $_context = 'tuteur';
	public $typeAlias = 'com_folia.tuteur';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Tuteur', $prefix = 'FoliaTable', $config = array()) 
	{
