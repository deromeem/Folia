...
class FoliaModelBibliotheque extends JModelAdmin
{
	protected $_compo = 'com_folia';
	protected $_context = 'bibliotheque';
	public $typeAlias = 'com_folia.bibliotheque';
	
	// Surcharges des m�thodes de la classe m�re pour :
	
	// 1) d�finir la table de soutien � utiliser
	public function getTable($type = 'Bibliotheque', $prefix = 'FoliaTable', $config = array())
	{
