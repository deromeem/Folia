...
class FoliaModelDocument extends JModelAdmin
{
	protected $_compo = 'com_folia';
	protected $_context = 'document';
	public $typeAlias = 'com_folia.document';
	
	// Surcharges des m�thodes de la classe m�re pour :
	
	// 1) d�finir la table de soutien � utiliser
	public function getTable($type = 'Document', $prefix = 'FoliaTable', $config = array()) 
	{
