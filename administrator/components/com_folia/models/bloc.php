...
class FoliaModelBloc extends JModelAdmin
{
	protected $_compo = 'com_folia';
	protected $_context = 'bloc';
	public $typeAlias = 'com_folia.bloc';
	
	// Surcharges des m�thodes de la classe m�re pour :
	
	// 1) d�finir la table de soutien � utiliser
	public function getTable($type = 'Bloc', $prefix = 'FoliaTable', $config = array()) 
	{
