...
class FoliaModelActivite extends JModelAdmin
{
	protected $_compo = 'com_folia';
	protected $_context = 'activite';
	public $typeAlias = 'com_folia.activite';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Activite', $prefix = 'FoliaTable', $config = array()) 
	{
