...
?>
	...
	<tr>
        ...
        <th width="30%" class="nowrap">
			<?php echo JHtml::_('grid.sort', 'COM_FOLIA_PROFESSEURS_EMAIL', 'p.email', $listDirn, $listOrder) ?>
        </th>      
        <th width="20%" class="nowrap">
			<?php echo JHtml::_('grid.sort', 'COM_FOLIA_PROFESSEURS_NOM', 'u.,nom', $listDirn, $listOrder) ?>
        </th>      
        <th width="20%" class="nowrap">
			<?php echo JHtml::_('grid.sort', 'COM_FOLIA_PROFESSEURS_PRENOM', 'u.prenom', $listDirn, $listOrder) ?>
        </th>
