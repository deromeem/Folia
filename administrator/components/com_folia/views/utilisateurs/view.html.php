...
class FoliaViewUtilisateurs extends JViewLegacy
{
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_FOLIA_OPTIONS')." : ".JText::_('COM_FOLIA_UTILISATEURS'));
 	...
 	protected function getSortFields()
	{
		...
		return array(
			'u.nom' => JText::_('COM_FOLIA_UTILISATEURS_NOM'),
			'u.prenom' => JText::_('COM_FOLIA_UTILISATEURS_PRENOM'),
			'u.email' => JText::_('COM_FOLIA_UTILISATEURS_EMAIl'),
			'u.id' => "Id"
		);
	}  
