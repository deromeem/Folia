...
class FoliaViewThemes extends JViewLegacy
{
	function display($tpl = null) 
	{
		...
		utilisateurHelper::addSubmenu('Themes');
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_FOLIA_OPTIONS')." : ".JText::_('COM_FOLIA_THEMES'));
		
		// affiche les boutons d'action
		JToolBarHelper::addNew('theme.add');
		JToolBarHelper::editList('theme.edit');
		JToolBarHelper::deleteList('Etes vous sur ?', 'themes.delete');		
		JToolbarHelper::publish('themes.publish', 'JTOOLBAR_PUBLISH', true);
		JToolbarHelper::unpublish('themes.unpublish', 'JTOOLBAR_UNPUBLISH', true);
		JToolbarHelper::archiveList('themes.archive');
		JToolbarHelper::checkin('themes.checkin');
		JToolbarHelper::trash('themes.trash');
 	...
 	protected function getSortFields()
	{
		...
		return array(
			't.titre' => JText::_('COM_FOLIA_THEMES_TITRE'),
			't.description' => JText::_('COM_FOLIA_THEMES_DESCRIPTION'),
			't.id' => "Id"
		);
	}  
