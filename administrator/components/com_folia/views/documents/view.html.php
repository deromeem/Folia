...
class FoliaViewDocuments extends JViewLegacy
{
	function display($tpl = null) 
	{
		...
		UtilisateurHelper::addSubmenu('documents');
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_FOLIA_DOCUMENTS'));
		
		// affiche les boutons d'action
		JToolBarHelper::addNew('document.add');
		JToolBarHelper::editList('document.edit');
		JToolBarHelper::deleteList('Etes vous sur ?', 'documents.delete');
 	...
 	protected function getSortFields()
	{
		...
		return array(
			'd.nom' => JText::_('COM_FOLIA_DOCUMENTS_NOM'),
			'd.alias' => JText::_('COM_FOLIA_DOCUMENTS_ALIAS'),
			'd.format' => JText::_('COM_FOLIA_DOCUMENTS_FORMAT'),
