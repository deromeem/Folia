...
class FoliaViewTuteursEtudiants extends JViewLegacy
{
	function display($tpl = null)
	{
		...
		UtilisateurHelper::addSubmenu('tuteursEtudiants');
	...
	protected function addToolBar()
	{
		...
		JToolbarHelper::archiveList('tuteursEtudiants.archive');
		JToolbarHelper::checkin('tuteursEtudiants.checkin');
		JToolbarHelper::trash('tuteursEtudiants.trash');
 	...
 	protected function getSortFields()
	{
		...
		return array(
			...
			'te.published' => JText::_('JSTATUS'),
			'te.modified' => JText::_('JDATE'),
			'te.tuteurs_id' => "Id"
		);
	}
