...
?>
	...
	<tr>
        ...
        <th width="35%">
                <?php echo JHtml::_('grid.sort', 'COM_FOLIA_BLOCS_TITRE', 'btitre', $listDirn, $listOrder) ?>
        </th>
        <th width="35%">
                <?php echo JHtml::_('grid.sort', 'COM_FOLIA_DOCUMENTS_TITRE', 'dtitre', $listDirn, $listOrder) ?>
        </th>
