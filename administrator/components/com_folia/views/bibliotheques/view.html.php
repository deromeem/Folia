...
class FoliaViewBibliotheques extends JViewLegacy
{
	function display($tpl = null) 
	{
		...
		utilisateurHelper::addSubmenu('Bibliotheques');
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_FOLIA_OPTIONS')." : ".JText::_('COM_FOLIA_BIBLIOTHEQUES'));
		
		// affiche les boutons d'action
		JToolBarHelper::addNew('bibliotheque.add');
		JToolBarHelper::editList('bibliotheque.edit');
		JToolBarHelper::deleteList('Etes vous sur ?', 'bibliotheques.delete');		
		JToolbarHelper::publish('bibliotheques.publish', 'JTOOLBAR_PUBLISH', true);
		JToolbarHelper::unpublish('bibliotheques.unpublish', 'JTOOLBAR_UNPUBLISH', true);
		JToolbarHelper::archiveList('bibliotheques.archive');
		JToolbarHelper::checkin('bibliotheques.checkin');
		JToolbarHelper::trash('bibliotheques.trash');
 	...
 	protected function getSortFields()
	{
		...
		return array(
			'u.nom' => JText::_('COM_FOLIA_BIBLIOTHEQUES_NOM'),
			'u.prenom' => JText::_('COM_FOLIA_BIBLIOTHEQUES_PRENOM'),
			'u.email' => JText::_('COM_FOLIA_BIBLIOTHEQUES_EMAIL'),
			'u.id' => "Id"
		);
	}  
