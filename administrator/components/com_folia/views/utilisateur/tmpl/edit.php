...
<script type="text/javascript">
	...
	{
		if (task == 'entreprise.cancel' || document.formvalidator.isValid(document.id('folia-form')))
		{
...
<form action="<?php echo JRoute::_('index.php?option=com_folia&layout=edit&id='.(int) $this->item->id); ?>"
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details', JText::_('COM_FOLIA_UTILISATEUR')); ?>
		<div class="row-fluid ">
			<div class="span9">
